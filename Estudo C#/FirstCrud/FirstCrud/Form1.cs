...
namespace FirstCrud
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Developed by:@BelizarioJv");
        }
        ...
        {
            // TODO: esta linha de código carrega dados na tabela 'database1DataSet.Pessoa'. Você pode movê-la ou removê-la conforme necessário.
